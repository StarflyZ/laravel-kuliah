        ...
        <div class="page-sidebar-wrapper">
            <div class="page-sidebar navbar-collapse collapse">
                ...
                <ul class="page-sidebar-menu">
                    ...
                    <li class="{{ request()->routeIs('kategori.halte') ? 'active' : '' }}">
                        <a href="{{ route('kategori.halte') }}">
                            <i class="icon-present"></i>
                            <span class="title">Halte</span>
                            <span class="arrow {{ request()->routeIs('kategori.halte') ? 'active' : '' }}"></span>
                        </a>
                    </li>
