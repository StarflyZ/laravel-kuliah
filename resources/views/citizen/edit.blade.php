    ...
    @section('content')
        ...
        <form method="POST" action="{{ route('citizen.update', $citizen->citizen_id) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" value="{{ $citizen->citizen_id }}" class="form-control" id="citizen_id"
                    name="citizen_id" aria-describedby="citizen_id" placeholder="Enter Citizen ID" disabled>
                </div>
            <div class="form-group">
